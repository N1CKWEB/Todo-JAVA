...
public class Contactos {
    ...
    public boolean modificarContacto(String dni, String nombre, String apellido, String correo, String direccion, String localidad) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al modificar el contacto: " + e.getMessage());
        }
    ...
    public static void main(String[] args) {
        ...
        contactos.modificarContacto("1233444", "Emilio", "Díaz", "nicolaszgaxxxrrido649@gmail.com", "Luzuariga 3319 23", "Acongua 111");
